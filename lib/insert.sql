...
-- VALUES (1,'Harry', 'leviosa', 'human')(2, 'Doby', 'lumos', 'elf' ),(3, 'Robinson', 'survive', 'human'),
-- (4, 'Bilbo', 'friendship is important', 'hobbit'), (5, 'Sauron', 'the dark', 'wizard'), (6, 'Peter', 'fly away', 'human'),
-- (7, 'Gimli', 'powerful', 'dwarf')(8, 'Gandalf', 'the gray', 'wizard');
--
--
-- INSERT INTO books (title, year, series_id)
-- VALUES('Hobbit', 2010, 2),('Fellowship', 2012, 1), ('Harry Potter', 2011, 2), ('The Wizard of Oz', 1990, 1),
-- ('Robinson Crusoe', 1991, 2),('Peter Pan', 1993, 1);
--
--
-- INSERT INTO series (title, author_id, subgenre_id) VALUES ('adventure'),('fantasy');
--
